...
.run(function($ionicPlatform,$cordovaSQLite,$rootScope,$ionicLoading,$ionicPopup,ApiEndpoint,ConnectivityMonitor,commonAppService,$state,DBA,$cordovaContacts,$http) {
    $rootScope.$on('loading:show', function() {
        $ionicLoading.show({template: '<p>Loading...Please wait !!! </p><ion-spinner icon="lines" class="spinner-assertive"></ion-spinner>'})
    });
    ...
    $ionicPlatform.ready(function() {
       ...
       var deviceID = device.uuid;
        ...
        //commonAppService.setDeviceId("123b11"); // seller-4268
        //commonAppService.setDeviceId("1a998ca53dbe55b2");
